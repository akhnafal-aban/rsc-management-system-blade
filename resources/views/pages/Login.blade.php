...
<div class="min-h-screen bg-gradient-to-br from-background to-muted flex items-center justify-center p-4">
  <div class="max-w-md w-full bg-card rounded-2xl shadow-xl p-8 border border-border">
    <div class="text-center mb-8">
      ...
      <p class="text-muted-foreground">Sistem Manajemen Gym Terlengkap</p>
    </div>
    <form class="space-y-6">
      <div>
        @include('components.UI.input', ['label' => 'Alamat Email', 'name' => 'email', 'type' => 'email', 'placeholder' => 'admin@reallysports.com', 'required' => true])
      </div>
      <div class="relative">
        @include('components.UI.input', ['label' => 'Password', 'name' => 'password', 'type' => 'password', 'placeholder' => 'Masukkan password Anda', 'required' => true])
      ...
      @include('components.UI.button', ['type' => 'submit', 'class' => 'w-full', 'size' => 'lg', 'slot' => 'Masuk'])
    </form>
    <div class="mt-6 p-4 bg-muted/50 rounded-lg">
      <p class="text-sm text-muted-foreground mb-2">Kredensial Demo:</p>
      <p class="text-xs text-muted-foreground/80">Email: admin@reallysports.com</p>
      <p class="text-xs text-muted-foreground/80">Password: admin123</p>
    </div>
